...
import com.indstudy.nicholas.thegarage.TablesObjects.Platform;
import com.indstudy.nicholas.thegarage.TablesObjects.VideoGame;
...
public class VideoGamesFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mListAdapter = new ArrayAdapter<>(getActivity(), R.layout.simple_list_item_1, R.id.empty_textView, videoGames);
